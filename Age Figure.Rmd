...
```{r, fig.cap= "Number of survey respondents who have planted cover crop in the last five years (top graph) versus the number of survey respondents who are interested in planting cover crop (bottom), by age range. Note: the question regarding *interest* in growing cover crop only appeared for those who selected *no* to having grown cover crop in the last 5 years. Thus, the total count in this analysis is lower than that of the cover crop *grown* analysis."}
